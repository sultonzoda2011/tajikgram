...
import { Eye, EyeClosed, LockKeyholeIcon, User } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-background animate-fade-in">
      <div className="w-full max-w-md bg-card shadow-2xl rounded-2xl p-10 border border-border animate-fade-in-up">
        <h1 className="text-4xl font-bold text-primary tracking-tight text-center mb-6">ChatGram</h1>
          ...
          <div>
            ...
            {eyeOpen ? (
              <Eye
                ...
                className="w-5 h-5 absolute  left-198 top-86 -translate-y-1/2 bg-white dark:bg-black text-muted-foreground/60 cursor-pointer"
              />
            ) : (
              <EyeClosed
                onClick={() => {
